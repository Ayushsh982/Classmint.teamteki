...
<head>
    ...
    <title>NEET 2026 Core Track</title>
...
<div class="container mt-5 mb-5">
    ...
    $jipmat_data = [
        'Quantitative Aptitude' => [
            'Basic Concepts' => ['Number System', 'Percentages', 'Profit and Loss', 'Averages', 'Ratio and Proportion'],
            'Advanced Concepts' => ['Time and Work', 'Time Speed Distance', 'Probability', 'Mensuration', 'Algebra']
        ],
        'Data Interpretation & Logical Reasoning' => [
            'Basic Concepts' => ['Blood Relations', 'Coding-Decoding', 'Series', 'Direction Sense'],
            'Advanced Concepts' => ['Data Sufficiency', 'Seating Arrangement', 'Syllogism', 'Venn Diagrams']
        ],
        'Verbal Ability & Reading Comprehension' => [
            'Basic Concepts' => ['Grammar Rules', 'Vocabulary', 'Synonyms and Antonyms', 'Idioms and Phrases'],
            'Advanced Concepts' => ['Reading Comprehension', 'Para Jumbles', 'Sentence Completion', 'Critical Reasoning']
        ]
    ];

    foreach ($jipmat_data as $subject => $grades) {
        ...
        foreach ($grades as $grade => $chapters) {
            ...
            if (empty($chapters)) {
                ...
                foreach ($chapters as $chapter) {
                    ...
                    echo '<a href="quiz.php?topic='.urlencode($chapter).'&exam=jipmat" class="btn btn-primary btn-sm mt-1">Start Test </a>';
                    echo '</div></div>';
                }
            }
            echo '</div></div></div>';
