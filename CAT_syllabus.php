...
<head>
    ...
    <title>CAT 2026 Core Track</title>
...
<div class="container mt-5 mb-5">
    <h2 class="mb-4 fw-bold">CAT 2026 Core Track</h2>
    <?php 
   $cat_data = [
    'Quantitative Aptitude' => [
        'Basic Concepts' => ['PERCENTAGES' , 'PROFIT & LOSS' , 'SIMPLE & COMPOUND INTEREST' , 'Ratio & Proportion' , 'Mixtures & Alligations' , 'Averages'],
        'Advanced Concepts' => ['Time, Speed & Distance', 'Time and Work' , 'Pipes & Cisterns' , 'Linear and Quadratic Equation' ,'Inequalities' , 'Logarithms & Functions' ,'Graphs & Maxima-Minima' , 'Geometry' , 'Sequences, Series & Progressions' , 'Coordinate Geometry' ,'Mensuration' , 'Permutations & Combinations', 'Probability']
    ],
    'Data Interpretation & Logical Reasoning' => [
        'Basic Concepts' => ['Pie Charts', 'Bar Charts', 'Caselets', 'Venn Diagram'],
        'Advanced Concepts' => ['Binary Logic', 'Cubes & Dices', 'Network Diagrams','Linear & Circular Arrangements','Games and Tournaments','Complex Matrix Match puzzles']
    ],
    ...
    foreach ($cat_data as $subject => $grades) {
        ...
        foreach ($grades as $grade => $chapters) {
            ...
            if (empty($chapters)) {
                ...
                foreach ($chapters as $chapter) {
                    ...
                    echo '<a href="quiz.php?topic='.urlencode($chapter).'&exam=CAT" class="btn btn-primary btn-sm mt-1">Start Test </a>';
                    echo '</div></div>';
                }
            }
            echo '</div></div></div>';
