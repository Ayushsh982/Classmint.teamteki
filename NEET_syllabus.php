...
<div class="container mt-5 mb-5">
    <h2 class="mb-4 fw-bold">NEET 2026 Core Track</h2>
    <?php 
    $neet_data = [
        'Physics' => [
        ...
        'Biology' => [
            'Class 11th' => ['Diversity in Living World', 'Structural Organisation', 'Cell Structure and Function', 'Plant Physiology', 'Human Physiology'],
            'Class 12th' => ['Reproduction', 'Genetics and Evolution', 'Biology and Human Welfare', 'Biotechnology', 'Ecology and Environment']
        ]
    ];

    foreach ($neet_data as $subject => $grades) {
        ...
        foreach ($grades as $grade => $chapters) {
            ...
            if (empty($chapters)) {
                ...
                foreach ($chapters as $chapter) {
                    ...
                    // Notice the exam=neet in the URL below
                    echo '<a href="quiz.php?topic='.urlencode($chapter).'&exam=neet" class="btn btn-primary btn-sm mt-1">Start Test </a>';
                    echo '</div></div>';
                }
            }
            echo '</div></div></div>';
